...
<div class="section section-padding theme-bg">
   <div class="container">
      ...
      <div class="section-title shape-03 text-center">
         ...
         <h2 class="main-title">Feedback from our <span> Students</span></h2>
      </div>
      <!-- Section Title End -->
         ...
         <div class="swiper-container">
            <div class="swiper-wrapper">
               ...
               <div class="single-testimonial swiper-slide">
                  <div class="testimonial-author">
                     <div class="author-thumb">
                        <img src="{{ asset('public/assets/front_assets/images/author/author-06.jpg') }}" alt="Author">
               ...
               <div class="single-testimonial swiper-slide">
                  <div class="testimonial-author">
                     <div class="author-thumb">
                        <img src="{{ asset('public/assets/front_assets/images/author/author-07.jpg') }}" alt="Author">
                        <i class="icofont-quote-left"></i>
                     </div>
                     <span class="rating-star">
                        <span class="rating-bar" style="width: 80%;"></span>
               ...
               <div class="single-testimonial swiper-slide">
                  <div class="testimonial-author">
                     <div class="author-thumb">
                        <img src="{{ asset('public/assets/front_assets/images/author/author-03.jpg') }}" alt="Author">
                        <i class="icofont-quote-left"></i>
                     </div>
                     <span class="rating-star">
                        <span class="rating-bar" style="width: 80%;"></span>
